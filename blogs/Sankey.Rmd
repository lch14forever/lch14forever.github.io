...
```{r data preparation}
download.file('https://bitbucket.org/biobakery/biobakery/raw/tip/demos/biobakery_demos/data/metaphlan2/output/SRS014476-Supragingival_plaque_profile.txt', destfile = 'SRS014476-Supragingival_plaque_profile.txt')
